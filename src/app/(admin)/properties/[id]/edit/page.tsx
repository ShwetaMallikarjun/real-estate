...
export default function EditPropertyPage({
  ...
  useEffect(() => {
    async function load() {
      try {
        const [propertyRes, agentsRes, locationsRes, developersRes] =
          await Promise.all([
        ...
        if (!propertyRes.success)
          throw new Error(propertyRes.message || "Property not found");
        ...
        reset({
          title: p.title,
          harga_asli: Number(p.harga_asli),
          harga_diskon: p.harga_diskon ? Number(p.harga_diskon) : undefined,
          status: p.status,
          jenis: p.jenis,
          luasBangunan: p.luasBangunan,
          luasTanah: p.luasTanah,
          furnitur: p.furnitur || undefined,
          kamarTidur: p.kamarTidur,
          kamarART: p.kamarART,
          kamarMandi: p.kamarMandi,
          kamarMandiART: p.kamarMandiART,
          garasi: p.garasi,
          listrik: p.listrik,
          air: p.air,
        ...
        setVideoInput((p.videoReview || []).join(", "));
      } catch (err) {
  ...
  async function onSubmit(data: PropertyInput) {
    ...
    if (!res.ok) {
      setError(json.message || "Gagal mengupdate properti");
      return;
    }
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-500">Ubah data properti</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <Card>
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="harga_asli" required>
                Harga Asli (Rp)
              </Label>
              <Input
                id="harga_asli"
                type="number"
                {...register("harga_asli", { valueAsNumber: true })}
              />
              {errors.harga_asli && (
                <p className="text-sm text-red-500">
                  {errors.harga_asli.message}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                id="harga_diskon"
                type="number"
                {...register("harga_diskon", { valueAsNumber: true })}
              />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="space-y-2">
              <Label htmlFor="luasBangunan" required>
                Luas Bangunan (m²)
              </Label>
              <Input
                id="luasBangunan"
                type="number"
                {...register("luasBangunan", { valueAsNumber: true })}
              />
              {errors.luasBangunan && (
                <p className="text-sm text-red-500">
            ...
            <div className="space-y-2">
              <Label htmlFor="luasTanah" required>
                Luas Tanah (m²)
              </Label>
              <Input
                id="luasTanah"
                type="number"
                {...register("luasTanah", { valueAsNumber: true })}
              />
              {errors.luasTanah && (
                <p className="text-sm text-red-500">
            ...
            <div className="space-y-2">
              ...
              <Input id="furnitur" {...register("furnitur")} />
            </div>

            <div className="space-y-2">
              <Label htmlFor="kamarTidur" required>
                Kamar Tidur
              </Label>
              <Input
                id="kamarTidur"
                type="number"
                {...register("kamarTidur", { valueAsNumber: true })}
              />
            </div>

            <div className="space-y-2">
              <Label htmlFor="kamarMandi" required>
                Kamar Mandi
              </Label>
              <Input
                id="kamarMandi"
                type="number"
                {...register("kamarMandi", { valueAsNumber: true })}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                id="kamarART"
                type="number"
                {...register("kamarART", { valueAsNumber: true })}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                id="kamarMandiART"
                type="number"
                {...register("kamarMandiART", { valueAsNumber: true })}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                id="garasi"
                type="number"
                {...register("garasi", { valueAsNumber: true })}
              />
            </div>

            <div className="space-y-2">
              <Label htmlFor="listrik" required>
                Listrik (Watt)
              </Label>
              <Input
                id="listrik"
                type="number"
                {...register("listrik", { valueAsNumber: true })}
              />
              {errors.listrik && (
                <p className="text-sm text-red-500">
                  {errors.listrik.message}
                </p>
              )}
            </div>

            <div className="space-y-2">
              <Label htmlFor="air" required>
                Air
              </Label>
              <Input id="air" {...register("air")} />
              {errors.air && (
                <p className="text-sm text-red-500">{errors.air.message}</p>
              )}
            </div>

            <div className="space-y-2">
              <Label htmlFor="sertifikat" required>
                Sertifikat
              </Label>
              <Input id="sertifikat" {...register("sertifikat")} />
              {errors.sertifikat && (
                <p className="text-sm text-red-500">
            ...
            <div className="space-y-2">
              <Label htmlFor="tahunPembuatan" required>
                Tahun Pembuatan
              </Label>
              <Input
                id="tahunPembuatan"
                type="number"
                {...register("tahunPembuatan", { valueAsNumber: true })}
              />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2 sm:col-span-2">
              ...
              <Textarea id="deskripsi" rows={5} {...register("deskripsi")} />
              {errors.deskripsi && (
                <p className="text-sm text-red-500">
            ...
            <div className="space-y-2">
              ...
              <Input id="maps" {...register("maps")} />
            </div>

            <div className="space-y-2">
              <Label htmlFor="agentId" required>
                Agent
              </Label>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="videoReview">
                Video Review YouTube (URL dipisah koma)
              </Label>
              <Textarea
                id="videoReview"
                rows={3}
